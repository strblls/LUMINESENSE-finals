...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
    header('Location: pages/admin-signup-page.php'); exit;
}
...
if ($stmt->num_rows > 0) {
    ...
    header('Location: pages/admin-signup-page.php');
    $stmt->close(); exit;
}
$stmt->close();
...
$_SESSION['signup_success'] = 'Account created! Coordinate with the Information Systems Office to get verified before logging in.';
