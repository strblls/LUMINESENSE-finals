...
#define ROW1_PIN    2    // P2  - MOSFET Gate Row 1
#define ROW2_PIN    15   // P15 - MOSFET Gate Row 2
#define ROW3_PIN    4    // P4  - MOSFET Gate Row 3
#define PIR_PIN     13   // P13 - PIR Sensor
#define SD_CS_PIN   5    // P5  - SD Card CS (ESP32 default SPI CS)
...
PZEM004Tv30 pzem(Serial1, 16, 17);   // PZEM on Hardware Serial1
