            ...
            <div class="main-container faculty-timetable w-auto mb-3">
                    ...
                    ?>
                        <div class="section-container head-timetable p-2 mb-3">
                            <div class="department-accent accent-active"></div>
                            <div class="head-timetable-body">
                                <h2 class="bold p-1"><i class="bi bi-diagram-3 me-1"></i>Department Overview</h2>
                                <p class="m-0"><i class="bi bi-info-circle me-1"></i>Name: <span class="bold department-emphases"><?= htmlspecialchars($dept['name']) ?></span></p>
