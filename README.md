...
| June 25 | Deployment | <ul><li>Fixed Hostinger: db_connect now has database name and etc. (sorry lex ginoverwrite ko tanan huhu -G)</li><li>Working now with hostinger instead of localhost</li></ul> | 
