...
| June 25 | Deployment | <ul><li>Fixed Hostinger: db_connect now has database name and etc. (sorry lex ginoverwrite ko tanan huhu -G)</li><li>Added localhost credentials in db_connect so that you may edit also in xampp-control</li></ul> | 
