...
EOT;
    ...
    public function testMsgHTML()
    {
        ...
        $this->Mail->msgHTML('<img src="composer/composer.json">test', realpath(\PHPMAILER_INCLUDE_DIR));
        self::assertStringNotContainsString('src="composer/composer.json"', $this->Mail->Body);
        ...
        $this->Mail->msgHTML('<img src="https://github.com/PHPMailer/PHPMailer/blob/master/composer/composer.json">test');
        self::assertStringContainsString(
            'src="https://github.com/PHPMailer/PHPMailer/blob/master/composer/composer.json"',
            $this->Mail->Body
        );
        ...
        $this->Mail->msgHTML('<img src="//github.com/PHPMailer/PHPMailer/blob/master/composer/composer.json">test');
        self::assertStringContainsString(
            'src="//github.com/PHPMailer/PHPMailer/blob/master/composer/composer.json"',
            $this->Mail->Body
        );
    }
